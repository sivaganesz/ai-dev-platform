...
import { Zap, CheckCircle, Clock, Loader2, AlertCircle, Palette } from "lucide-react";

export default function UXAgentPage() {
  const { data, isLoading, isError } = useAgentByType("UX");
  ...
  if (isError || !data) {
    return (
      <div className="flex h-[400px] items-center justify-center text-destructive">
        ...
        <span>Failed to load UX agent data</span>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Specialized in user experience design, wireframing, and interactive prototyping.</p>
        </div>
      </div>
