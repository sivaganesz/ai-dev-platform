...
import { Zap, CheckCircle, Clock, Loader2, AlertCircle, Cloud } from "lucide-react";

export default function DevOpsAgentPage() {
  const { data, isLoading, isError } = useAgentByType("DEVOPS");
  ...
  if (isError || !data) {
    return (
      <div className="flex h-[400px] items-center justify-center text-destructive">
        ...
        <span>Failed to load DevOps agent data</span>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Specialized in CI/CD pipelines, cloud infrastructure, and deployment automation.</p>
        </div>
      </div>
