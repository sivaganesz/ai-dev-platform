...
import { Zap, CheckCircle, Clock, Loader2, AlertCircle, FileCode } from "lucide-react";

export default function FrontendAgentPage() {
  const { data, isLoading, isError } = useAgentByType("FRONTEND");
  ...
  if (isError || !data) {
    return (
      <div className="flex h-[400px] items-center justify-center text-destructive">
        ...
        <span>Failed to load Frontend agent data</span>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Specialized in UI/UX implementation and frontend optimization.</p>
        </div>
      </div>
