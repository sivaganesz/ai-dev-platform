...
import { Zap, CheckCircle, Clock, Loader2, AlertCircle, Hammer } from "lucide-react";

export default function BackendAgentPage() {
  const { data, isLoading, isError } = useAgentByType("BACKEND");
  ...
  if (isError || !data) {
    return (
      <div className="flex h-[400px] items-center justify-center text-destructive">
        ...
        <span>Failed to load Backend agent data</span>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Specialized in API development, database optimization, and business logic.</p>
        </div>
      </div>
